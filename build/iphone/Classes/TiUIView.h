...
/**
 Base class for all RutaTeresiana views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the RutaTeresiana view hierarchy (such as wrapped iOS UIViews) was touched.
