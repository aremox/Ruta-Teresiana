...
@interface RutaTeresianaObject : KrollCoverageObject {
#else
@interface RutaTeresianaObject : KrollObject {
#endif
@private
...
extern NSString * RutaTeresiana$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	RutaTeresianaObject *_rutateresiana;
    KrollObject* console;
	BOOL shutdown;
