...
//@interface RutaTeresianaObject : NSObject
//@end

@interface RutaTeresianaObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[RutaTeresianaObject class]])
		{
			for (NSString *key in [[(RutaTeresianaObject*)o modules] allKeys])
			{
