...
// in simulator we redefine to format for RutaTeresiana Developer console
...
{\
	NSString * exceptionName = [@"org.rutateresiana." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.rutateresiana";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIRutaTeresianaNativeItemNone = -1, 
	UIRutaTeresianaNativeItemSpinner = -2,
	UIRutaTeresianaNativeItemProgressBar = -3,
	
	UIRutaTeresianaNativeItemSlider = -4,
	UIRutaTeresianaNativeItemSwitch = -5,
	UIRutaTeresianaNativeItemMultiButton = -6,
	UIRutaTeresianaNativeItemSegmented = -7,
	
	UIRutaTeresianaNativeItemTextView = -8,
	UIRutaTeresianaNativeItemTextField = -9,
	UIRutaTeresianaNativeItemSearchBar = -10,
	
	UIRutaTeresianaNativeItemPicker = -11,
	UIRutaTeresianaNativeItemDatePicker = -12,
	
	UIRutaTeresianaNativeItemInfoLight = -13,
	UIRutaTeresianaNativeItemInfoDark = -14,
	
	UIRutaTeresianaNativeItemDisclosure = -15,
	
	UIRutaTeresianaNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all RutaTeresiana instances of
