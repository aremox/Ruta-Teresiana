...
//Rare exceptions to indicate a bug in the _rutateresiana code (Eg, function that a subclass should have implemented)
...
/**
 The base class for RutaTeresiana proxies.
 */
